...
export default function Header({ onSearch }: HeaderProps) {
  ...
  return (
    <header
      className="bg-gradient-header text-white px-4 md:px-6 py-3
                 flex items-center gap-3 md:gap-4
                 shadow-header sticky top-0 z-50"
    >
      {/* Logo */}
      <Link href="/">
        <h1 className="text-xl md:text-2xl font-bold tracking-wide whitespace-nowrap
                       drop-shadow-sm select-none hover:opacity-80 transition-opacity">
          Sakura
        </h1>
      </Link>
