...
async function main() {
  ...
  const admin = await prisma.user.upsert({
    where: { email: 'admin@kodkong.com' },
    update: {},
    create: {
      email: 'admin@kodkong.com',
  ...
  const staff = await prisma.user.upsert({
    where: { email: 'staff@kodkong.com' },
    update: {},
    create: {
      email: 'staff@kodkong.com',
      password: hashedPassword,
      name: 'Staff User',
      phone: '08-2222-2222',
      role: UserRole.STAFF,
  ...
  console.log('\n🔐 Test Credentials:')
  console.log('Admin: admin@kodkong.com / password123')
  console.log('Staff: staff@kodkong.com / password123')
